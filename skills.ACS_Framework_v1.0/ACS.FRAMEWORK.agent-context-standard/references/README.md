...
[![Status: Stable](https://img.shields.io/badge/status-stable-brightgreen.svg)](skills.ACS_Framework_v1.0/VERSION.md)
...
git clone https://github.com/confianza23/agent-context-standard.git
cd agent-context-standard

# 2. Copy the framework bundle into your project
cp -r skills.ACS_Framework_v1.0 /path/to/your-project/

# 3. In your project, run /init in your agent harness, then say:
"load ACS"   # or  "carga ACS"
```

The bundled `ACS.FRAMEWORK.agent-context-standard` skill detects whether the project already has ACS, creates the canonical layout from templates if not, copies the standard reference to the project, and reports the compliance level reached.
...
| 🧱 [`skills.ACS_Framework_v1.0/`](skills.ACS_Framework_v1.0/) | The reference framework bundle — copy this directory into any project to install ACS |

Inside the framework bundle:

| Path | Purpose |
|---|---|
| 🚀 [`skills.ACS_Framework_v1.0/ACS.FRAMEWORK.agent-context-standard/SKILL.md`](skills.ACS_Framework_v1.0/ACS.FRAMEWORK.agent-context-standard/SKILL.md) | Bootstrap skill — triggered by saying "load ACS" / "carga ACS" |
| 📋 [`skills.ACS_Framework_v1.0/VERSION.md`](skills.ACS_Framework_v1.0/VERSION.md) | Read-only invariant and draft → promote workflow |
| 🗂️ [`skills.ACS_Framework_v1.0/INDEX.md`](skills.ACS_Framework_v1.0/INDEX.md) | Index of the 7 bundled skills (framework + ACS utilities) |
| 🌐 [`skills.ACS_Framework_v1.0/ACS.docs.bilingual/SKILL.md`](skills.ACS_Framework_v1.0/ACS.docs.bilingual/SKILL.md) | Bilingual documentation parity skill (used to keep these two READMEs in sync) |
...
Edits to the canonical English document require a corresponding update to translations (line-for-line parity). The [`ACS.docs.bilingual`](skills.ACS_Framework_v1.0/ACS.docs.bilingual/SKILL.md) skill enforces this.
...
<sub>Agent Context Standard v1.0 · Built on top of [Agent Skills](https://agentskills.io) · Published under [CC-BY-4.0](LICENSE)</sub>
